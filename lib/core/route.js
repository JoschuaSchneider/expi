...
Route.prototype.validateRequest = function(request){
	...
	return Joi.validate(request, this.requestValidator, { abortEarly: false, language: {
		key: "'{{!key}}'"
	}})
}
...
Route.prototype.validateResponse = function(response){
	...
	return Joi.validate(response, this.responseValidator, { abortEarly: false, language: {
		key: "'{{!key}}'"
	}})
}
